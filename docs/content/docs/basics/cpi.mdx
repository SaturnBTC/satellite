...
declare_id!("79682ef9ed3a341650194514da13eafb6bb97090a9c7de3212da92b832dc3989");
...
```rust
use satellite_lang::arch_program::{program::invoke, system_instruction};
```
...
declare_id!("1e80b945175b766786e79fac45f6a5712f282d9ef662aabf7d3545ce88833bf8");
...
```rust
use satellite_lang::arch_program::{program::invoke_signed, system_instruction};
```
