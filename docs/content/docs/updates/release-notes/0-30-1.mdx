...
```
satellite-lang-idl = { version = "0.1.1", features = ["convert"] }
```

and use the
[`convert_idl`](https://docs.rs/satellite-lang-idl/0.1.1/satellite_lang_idl/convert/fn.convert_idl.html)
function.
...
To fix this problem, a new [crate](https://docs.rs/satellite-lang-idl-spec) that
...
[`satellite_lang_idl::types`](https://docs.rs/satellite-lang-idl/0.1.1/satellite_lang_idl/types/index.html).
...
[`declare_program!`](https://www.satellite-lang.com/release-notes/0.30.0#dependency-free-program-declaration)
...
[`solana-program`](https://docs.rs/solana-program/1.18.17/arch_program/index.html)
has
[`pubkey!`](https://docs.rs/solana-program/1.18.17/arch_program/macro.pubkey.html)
...
the macro was specifically using `::arch_program`.

You can now directly use `pubkey!` as it's exported from `satellite_lang::prelude`.

Note that because `arch_program` is exported from `satellite_lang`, you can also
...
[`declare_id!`](https://docs.rs/satellite-lang/0.30.1/satellite_lang/macro.declare_id.html)
and
[`declare_program!`](https://docs.rs/satellite-lang/0.30.1/satellite_lang/macro.declare_program.html)
...
[token extensions constraints](https://www.satellite-lang.com/release-notes/0.30.0#token-extensions)
has been improved.
...
crate is now re-exported from `satellite_apl::associated_token`.

Similar to how you can
[remove](https://www.satellite-lang.com/release-notes/0.29.0#export-mpl-token-metadata)
the `mpl-token-metadata` crate from your dependency list, you can also remove
`spl-associated-token-accounts` crate.

```toml
[dependencies]
satellite-apl = "0.30.1"
...
The
[account resolution](https://www.satellite-lang.com/release-notes/0.30.0#account-resolution)
